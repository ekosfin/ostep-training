...
main (int argc, char *argv[])
{
  ...
  24:	50                   	push   %eax
  25:	50                   	push   %eax
  26:	68 c5 07 00 00       	push   $0x7c5
  2b:	6a 02                	push   $0x2
  2d:	e8 0e 04 00 00       	call   440 <printf>
    exit();
  32:	e8 ac 02 00 00       	call   2e3 <exit>
        if (!strcmp(argv[1],comp))
  37:	51                   	push   %ecx
  38:	51                   	push   %ecx
  39:	68 a8 07 00 00       	push   $0x7a8
  3e:	ff 72 04             	pushl  0x4(%edx)
  41:	e8 6a 00 00 00       	call   b0 <strcmp>
  46:	83 c4 10             	add    $0x10,%esp
  49:	85 c0                	test   %eax,%eax
  4b:	75 1e                	jne    6b <main+0x6b>
            count(a);
  4d:	83 ec 0c             	sub    $0xc,%esp
  50:	6a 01                	push   $0x1
  52:	e8 2c 03 00 00       	call   383 <count>
            exit();
  57:	e8 87 02 00 00       	call   2e3 <exit>
        count(a);
  5c:	83 ec 0c             	sub    $0xc,%esp
  5f:	6a 00                	push   $0x0
  61:	e8 1d 03 00 00       	call   383 <count>
        exit();
  66:	e8 78 02 00 00       	call   2e3 <exit>
        printf(2,"to reset: count reset\n");
  6b:	52                   	push   %edx
  6c:	52                   	push   %edx
  6d:	68 ae 07 00 00       	push   $0x7ae
  72:	6a 02                	push   $0x2
  74:	e8 c7 03 00 00       	call   440 <printf>
        exit();
  79:	e8 65 02 00 00       	call   2e3 <exit>
  7e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb e2 07 00 00       	mov    $0x7e2,%ebx
        while(*s != 0){
