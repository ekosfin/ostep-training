...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 1b 7b 10 80 	movl   $0x80107b1b,(%esp)
...
80102020:	68 02 79 10 80       	push   $0x80107902
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 2f 59 10 80 	movl   $0x8010592f,0x14(%eax)
  p->context = (struct context*)sp;
...
8010392d:	68 b4 77 10 80       	push   $0x801077b4
...
801039a7:	e8 44 35 00 00       	call   80106ef0 <setupkvm>
...
801039c5:	e8 f6 31 00 00       	call   80106bc0 <inituvm>
...
80103abf:	e8 ec 2f 00 00       	call   80106ab0 <switchuvm>
  return 0;
...
80103b4c:	e8 6f 34 00 00       	call   80106fc0 <copyuvm>
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 ea 2d 00 00       	call   80106e70 <freevm>
        release(&ptable.lock);
...
801041f3:	68 1b 7b 10 80       	push   $0x80107b1b
...
801042af:	7f 1f                	jg     801042d0 <count+0x30>
    countCalls = 0;
...
801042b4:	ff 35 b8 a5 10 80    	pushl  0x8010a5b8
801042ba:	68 dc 77 10 80       	push   $0x801077dc
801042bf:	e8 ec c3 ff ff       	call   801006b0 <cprintf>
  return 22;
801042c4:	83 c4 10             	add    $0x10,%esp
}
801042c7:	b8 16 00 00 00       	mov    $0x16,%eax
801042cc:	c9                   	leave  
801042cd:	c3                   	ret    
801042ce:	66 90                	xchg   %ax,%ax
    countCalls = 0;
801042d0:	c7 05 b8 a5 10 80 00 	movl   $0x0,0x8010a5b8
801042d7:	00 00 00 
    cprintf("Laskin resetoitu\n");
801042da:	83 ec 0c             	sub    $0xc,%esp
801042dd:	68 78 77 10 80       	push   $0x80107778
801042e2:	e8 c9 c3 ff ff       	call   801006b0 <cprintf>
    return 22;
801042e7:	83 c4 10             	add    $0x10,%esp
}
801042ea:	b8 16 00 00 00       	mov    $0x16,%eax
801042ef:	c9                   	leave  
801042f0:	c3                   	ret    
801042f1:	66 90                	xchg   %ax,%ax
...
8010430e:	68 24 78 10 80       	push   $0x80107824
...
80104555:	68 2f 78 10 80       	push   $0x8010782f
8010455a:	e8 31 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 46 78 10 80       	push   $0x80107846
...
80104667:	68 4d 78 10 80       	push   $0x8010784d
...
801046c0:	68 55 78 10 80       	push   $0x80107855
...
80104abe:	77 30                	ja     80104af0 <syscall+0x50>
80104ac0:	8b 14 85 80 78 10 80 	mov    -0x7fef8780(,%eax,4),%edx
80104ac7:	85 d2                	test   %edx,%edx
80104ac9:	74 25                	je     80104af0 <syscall+0x50>

    if (num == 5)
80104acb:	83 f8 05             	cmp    $0x5,%eax
80104ace:	75 07                	jne    80104ad7 <syscall+0x37>
    {
      countCalls++;
80104ad0:	83 05 b8 a5 10 80 01 	addl   $0x1,0x8010a5b8
    }
...
80104af8:	68 5d 78 10 80       	push   $0x8010785d
...
80104c54:	68 f8 78 10 80       	push   $0x801078f8
...
80104c6c:	68 f7 78 10 80       	push   $0x801078f7
...
80104c81:	68 eb 78 10 80       	push   $0x801078eb
...
80104c9f:	68 fa 78 10 80       	push   $0x801078fa
80104ca4:	e8 e7 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104ca9:	83 ec 0c             	sub    $0xc,%esp
80104cac:	68 dc 78 10 80       	push   $0x801078dc
...
8010509d:	58                   	pop    %eax
8010509e:	5a                   	pop    %edx
8010509f:	68 f8 78 10 80       	push   $0x801078f8
...
801050b8:	68 f7 78 10 80       	push   $0x801078f7
...
80105710:	f3 0f 1e fb          	endbr32 
  return fork();
80105714:	e9 f7 e3 ff ff       	jmp    80103b10 <fork>
...
80105727:	83 ec 08             	sub    $0x8,%esp
  exit();
8010572a:	e8 61 e6 ff ff       	call   80103d90 <exit>
...
80105740:	f3 0f 1e fb          	endbr32 
  return wait();
80105744:	e9 97 e8 ff ff       	jmp    80103fe0 <wait>
...
80105760:	e8 4b f2 ff ff       	call   801049b0 <argint>
...
80105772:	e8 c9 e9 ff ff       	call   80104140 <kill>
...
801057c1:	e8 ea f1 ff ff       	call   801049b0 <argint>
...
801057da:	e8 b1 e2 ff ff       	call   80103a90 <growproc>
...
80105811:	e8 9a f1 ff ff       	call   801049b0 <argint>
...
80105824:	68 80 4c 11 80       	push   $0x80114c80
80105829:	e8 92 ed ff ff       	call   801045c0 <acquire>
  ticks0 = ticks;
...
80105848:	68 c0 54 11 80       	push   $0x801154c0
8010584d:	e8 ce e6 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105852:	a1 c0 54 11 80       	mov    0x801154c0,%eax
...
8010585f:	73 2f                	jae    80105890 <sys_sleep+0x90>
    if(myproc()->killed){
80105861:	e8 fa e0 ff ff       	call   80103960 <myproc>
...
80105870:	68 80 4c 11 80       	push   $0x80114c80
...
80105893:	68 80 4c 11 80       	push   $0x80114c80
...
801058b8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058bb:	68 80 4c 11 80       	push   $0x80114c80
801058c0:	e8 fb ec ff ff       	call   801045c0 <acquire>
  xticks = ticks;
801058c5:	8b 1d c0 54 11 80    	mov    0x801154c0,%ebx
  release(&tickslock);
801058cb:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
801058d2:	e8 a9 ed ff ff       	call   80104680 <release>
  return xticks;
}
...
801058f0:	e8 bb f0 ff ff       	call   801049b0 <argint>
801058f5:	83 c4 10             	add    $0x10,%esp
801058f8:	85 c0                	test   %eax,%eax
801058fa:	78 14                	js     80105910 <sys_count+0x30>
    return -1;

  return count(check);
801058fc:	83 ec 0c             	sub    $0xc,%esp
801058ff:	ff 75 f4             	pushl  -0xc(%ebp)
80105902:	e8 99 e9 ff ff       	call   801042a0 <count>
...
8010598e:	00 00 ef 
  initlock(&tickslock, "time");
80105991:	68 3d 79 10 80       	push   $0x8010793d
...
801059cf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059d3:	b8 c0 4c 11 80       	mov    $0x80114cc0,%eax
...
80105a14:	3e ff 24 85 e4 79 10 	notrack jmp *-0x7fef861c(,%eax,4)
80105a1b:	80 
    lapiceoi();
    break;
...
80105a1c:	e8 3f df ff ff       	call   80103960 <myproc>
...
80105a3c:	e8 ff de ff ff       	call   80103940 <cpuid>
...
80105a71:	68 a0 79 10 80       	push   $0x801079a0
...
80105a93:	e8 c8 de ff ff       	call   80103960 <myproc>
...
80105ad1:	e8 8a de ff ff       	call   80103960 <myproc>
...
80105b09:	eb a5                	jmp    80105ab0 <trap+0xc0>
    if(cpuid() == 0){
80105b0b:	e8 30 de ff ff       	call   80103940 <cpuid>
80105b10:	85 c0                	test   %eax,%eax
80105b12:	75 e7                	jne    80105afb <trap+0x10b>
      acquire(&tickslock);
80105b14:	83 ec 0c             	sub    $0xc,%esp
80105b17:	68 80 4c 11 80       	push   $0x80114c80
80105b1c:	e8 9f ea ff ff       	call   801045c0 <acquire>
      wakeup(&ticks);
80105b21:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      ticks++;
80105b28:	83 05 c0 54 11 80 01 	addl   $0x1,0x801154c0
      wakeup(&ticks);
80105b2f:	e8 ac e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105b34:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
...
80105b66:	e8 55 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6b:	e8 f0 dd ff ff       	call   80103960 <myproc>
...
80105b84:	e8 b7 dd ff ff       	call   80103940 <cpuid>
80105b89:	57                   	push   %edi
80105b8a:	56                   	push   %esi
80105b8b:	50                   	push   %eax
80105b8c:	68 48 79 10 80       	push   $0x80107948
...
80105bb4:	0f 85 0e ff ff ff    	jne    80105ac8 <trap+0xd8>
    yield();
80105bba:	e8 11 e3 ff ff       	call   80103ed0 <yield>
...
80105bd2:	75 3c                	jne    80105c10 <trap+0x220>
    myproc()->tf = tf;
80105bd4:	e8 87 dd ff ff       	call   80103960 <myproc>
...
80105bf7:	5d                   	pop    %ebp
      exit();
80105bf8:	e9 93 e1 ff ff       	jmp    80103d90 <exit>
...
80105c17:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c1a:	e8 21 dd ff ff       	call   80103940 <cpuid>
...
80105c28:	68 6c 79 10 80       	push   $0x8010796c
80105c2d:	e8 7e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c32:	83 c4 14             	add    $0x14,%esp
80105c35:	68 42 79 10 80       	push   $0x80107942
...
80105c40:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105c44:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
...
80105d1b:	74 52                	je     80105d6f <uartinit+0xaf>
  uart = 1;
80105d1d:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105d24:	00 00 00 
...
80105d33:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d38:	bb 64 7a 10 80       	mov    $0x80107a64,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105d50:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105d54:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
80105d84:	55                   	push   %ebp
  if(!uart)
80105d85:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
{
...
8010693d:	68 6c 7a 10 80       	push   $0x80107a6c
...
80106a07:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a0a:	e8 31 cf ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106a1e:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106a25:	ff 00 00 
80106a28:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106a2f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a32:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106a39:	ff 00 00 
80106a3c:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106a43:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a46:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106a4d:	ff 00 00 
80106a50:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106a57:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a5a:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
80106a61:	ff 00 00 
80106a64:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106a6b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a6e:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106a94:	a1 c4 54 11 80       	mov    0x801154c4,%eax
...
80106aea:	e8 e1 cd ff ff       	call   801038d0 <mycpu>
...
80106afc:	e8 cf cd ff ff       	call   801038d0 <mycpu>
...
80106c2f:	68 b1 7a 10 80       	push   $0x80107ab1
...
80106d99:	68 e9 7a 10 80       	push   $0x80107ae9
...
80106dfb:	68 01 7b 10 80       	push   $0x80107b01
...
80106edc:	68 1d 7b 10 80       	push   $0x80107b1d
...
80106f7f:	a3 c4 54 11 80       	mov    %eax,0x801154c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fb3:	68 2e 7b 10 80       	push   $0x80107b2e
...
80107099:	68 52 7b 10 80       	push   $0x80107b52
8010709e:	e8 ed 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801070a3:	83 ec 0c             	sub    $0xc,%esp
801070a6:	68 38 7b 10 80       	push   $0x80107b38
